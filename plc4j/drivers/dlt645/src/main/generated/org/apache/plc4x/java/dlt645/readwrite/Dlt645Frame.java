...
public class Dlt645Frame implements Message {
  ...
  public void serialize(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("Dlt645Frame"), WithOption.WithFloatEncoding("IEEE754"), WithOption.WithSignedIntegerEncoding("twos-complement"), WithOption.WithUnsignedIntegerEncoding("unsigned-binary"), WithByteBasedOption.WithByteOrder("BIG_ENDIAN"), WithOption.WithStringEncoding("UTF8"));
  ...
  public static Dlt645Frame staticParse(ReadBuffer readBuffer, boolean response)
    ...
    readBuffer.pushContext(WithOption.WithName("Dlt645Frame"), WithOption.WithFloatEncoding("IEEE754"), WithOption.WithSignedIntegerEncoding("twos-complement"), WithOption.WithUnsignedIntegerEncoding("unsigned-binary"), WithByteBasedOption.WithByteOrder("BIG_ENDIAN"), WithOption.WithStringEncoding("UTF8"));
    ...
    byte[] dataPlain =
        FieldReaderFactory.readManualByteArrayField(
            ...
            () -> (byte) (org.apache.plc4x.java.dlt645.readwrite.utils.StaticHelper.parseDataByteMinus33(readBuffer)),
    ...
    short cs =
        FieldReaderFactory.readChecksumField(
            DataReaderFactory.readUnsignedShort(readBuffer, 8),
            (short) (org.apache.plc4x.java.dlt645.readwrite.utils.StaticHelper.calcCs(address, control, length, dataPlain)),
