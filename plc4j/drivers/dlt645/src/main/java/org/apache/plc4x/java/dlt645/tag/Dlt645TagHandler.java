...
public class Dlt645TagHandler implements PlcTagHandler {
    ...
    public PlcTag parseTag(String tagAddress) {
        ...
        if (Dlt645Tag.matches(tagAddress)) {
    ...
    public PlcQuery parseQuery(String query) {
        throw new UnsupportedOperationException("DL/T 645-2007 driver does not support browsing");
    }
}
