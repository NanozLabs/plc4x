...
public class Cjt188TagHandler implements PlcTagHandler {
    ...
    public PlcTag parseTag(String tagAddress) {
        ...
        if (Cjt188Tag.matches(tagAddress)) {
    ...
    public PlcQuery parseQuery(String query) {
        throw new UnsupportedOperationException("CJ/T 188-2004 driver does not support browsing");
    }
}
